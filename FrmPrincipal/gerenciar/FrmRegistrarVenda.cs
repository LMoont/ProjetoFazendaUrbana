...
namespace FrmPrincipal.gerenciar
{
    public partial class FrmRegistrarVenda : Form
    {
        ...
        {
            string sqlSelect = "SELECT ClienteId, Nome, CPF_CNPJ FROM tbCliente";
            ...
            using (ConexaoDB conexao = new ConexaoDB())
            {
                using (SqlCommand cmd = new SqlCommand(sqlSelect, conexao.AbrirConexao()))
                {
                    ...
                    dt.Columns.Add("Exibicao", typeof(string), "Nome + ' - ' + CPF_CNPJ");

                    cmbCliente.DataSource = dt;
                    cmbCliente.DisplayMember = "Exibicao";
        ...
        private void RegistrarVenda()
        {
            ...
            string sqlInsert = "INSERT INTO tbVenda (ProdutoColhidoId, Quantidade, PrecoVenda, DataVenda, ClienteId) " +
                               "VALUES (@ProdutoColhidoId, @Quantidade, @PrecoVenda, @DataVenda, @ClienteId)";
            ...
            using (ConexaoDB conexao = new ConexaoDB())
            {
                using (SqlCommand cmdEstoque = new SqlCommand(sqlInsert, conexao.AbrirConexao()))
                {
                    ...
                    cmdEstoque.Parameters.AddWithValue("@ClienteId", clienteId);
        ...
        {
            ValidarCampos();
            FrmPrincipal.AtualizarBlocoVendas();
        }
